...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'role' => ['required', Rule::in(['admin', 'inspektur_daerah', 'inspektur_pembantu_1', 'ketua_tim', 'auditor', 'skpd', 'pengendali_teknis'])],
            'tim' => ['nullable', 'required_if:role,ketua_tim,auditor,skpd,pengendali_teknis', Rule::in(['tim_1', 'tim_2'])],
        ...
        User::create([
            ...
            'role' => $request->role,
            'tim' => in_array($request->role, ['ketua_tim', 'auditor', 'skpd', 'pengendali_teknis']) ? $request->tim : null,
            'opd_id' => null,
            'nip' => $request->nip,
